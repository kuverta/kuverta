 ...
 *
 * This is `kuverta`'s own window rather than the shared surface, and it lives
...
// The repository root: the window's page is under apps/, the double under kuverta-bird/.
